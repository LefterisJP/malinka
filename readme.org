...
(malinka-define-project
 :name "ethereum"
 :build-cmd "cmake .. -DCMAKE_BUILD_TYPE=Debug -DHEADLESS=1"
...
** build-cmd
This is the command to build and configure the project for malinka. This is what malinka will use to create the
...
*** cmake > 2.84
If malinka detects you are using cmake with version greater than 2.84 then it will use cmake to create
...
- *malinka-files-list-populator*:
  (DEPRECATED -- will probably remove. build-cmd is the way to go)
